...
export class InvalidEmailAddressError extends BaseError {
  constructor(public readonly email: string, public readonly rule: string) {
    super("InvalidEmailAddressError", `Invalid email address: ${email}. ${rule}`, 422);
  }
}

export class InvalidEmailSuffixError extends BaseError {
  constructor(public readonly email: string, public readonly rule: string) {
    super("InvalidEmailSuffixError", `Invalid email suffix: ${email}. ${rule}`, 422);
  }
}

export class EmailAlreadyRegisteredError extends BaseError {
  constructor(public readonly email: string) {
    super("EmailAlreadyRegisteredError", `Email already registered: ${email}`, 409);
  }
}
...
export class InvalidUsernameError extends BaseError {
  constructor(public readonly username: string, public readonly rule: string) {
    super("InvalidUsernameError", `Invalid username: ${username}. ${rule}`, 422);
  }
}
...
export class InvalidNicknameError extends BaseError {
  constructor(public readonly nickname: string, public readonly rule: string) {
    super("InvalidNicknameError", `Invalid nickname: ${nickname}. ${rule}`, 422);
  }
}
...
export class UsernameAlreadyRegisteredError extends BaseError {
  constructor(public readonly username: string) {
    super("UsernameAlreadyRegisteredError", `Username already registered: ${username}`, 409);
  }
}
...
export class UsernameNotFoundError extends BaseError {
  constructor(public readonly username: string) {
    super("UsernameNotFoundError", `User with username ${username} not found`, 404);
  }
}

export class PasswordNotMatchError extends BaseError {
  constructor(public readonly username: string) {
    super("PasswordNotMatchError", `Password not match for user ${username}`, 401);
  }
}
...
export class PasswordResetTokenExpiredError extends BaseError {
  constructor() {
    super("PasswordResetTokenExpiredError", "Password reset token expired.", 401);
  }
}

export class NotFollowedYetError extends BaseError {
  constructor(public readonly followeeId: number) {
    super("NotFollowedYetError", `User with id ${followeeId} is not followed yet.`, 422);
  }
}
